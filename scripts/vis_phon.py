...
def main():
    ...
    if args.compare:
        ...
        example_pairs = [
            ...
            ("book", "cheese", "audiological", "Audiological confusion", "f → θ", "Labiodental to dental fricative"),
            ("pen", "goat", "audiological", "Audiological confusion", "ʃ → s", "Postalveolar to alveolar fricative"),
            ("window", "candle", "audiological", "Audiological confusion", "ʃ → θ", "Postalveolar to dental fricative"),
            ("pencil", "sunset", "audiological", "Audiological confusion", "θ → s", "Dental to alveolar fricative"),
            ("table", "mango", "audiological", "Audiological confusion", "θ → s", "Dental to alveolar fricative"),
            
            # Examples testing boundary effects
            ("moose", "hat", "resyllabification", "Cross-word resyllabification", "s.h → s.aʊ", "Boundary shift"),
            ("oreo", "owl", "resyllabification", "Cross-word resyllabification", "ən.eɪm → ə.neɪm", "Boundary shift"),
            ("bath", "bass", "resyllabification", "Cross-word resyllabification", "aɪs.krim → aɪ.skrim", "Boundary shift"),
            ("key", "mouth", "resyllabification", "Cross-word resyllabification", "ðæt.stʌf → ðæts.tʌf", "Boundary shift"),
            ("voice", "architect", "resyllabification", "Cross-word resyllabification", "ðæt.stʌf → ðæts.tʌf", "Boundary shift"),
        ]
        
        print(f"\n=== Comparing Standard vs. Phonetically-Weighted Visemes Scores (Method: {args.weight_method}) ===\n")
